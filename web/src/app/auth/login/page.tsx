        ...
        <div className="w-full max-w-md bg-surface-container-lowest rounded-2xl border border-surface-container-high/70 shadow-xl p-space-lg flex flex-col gap-space-md">
          ...
          <div className="text-center flex flex-col items-center gap-1">
            ...
            <p className="font-body-sm text-on-surface-variant">
              Access emergency dispatch telemetry, hospital comparison matrix, and patient services.
            </p>
          </div>
          ...
          <div className="bg-surface-container-low rounded-xl p-3 border border-surface-container-high/60 flex flex-col gap-1.5">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-1.5 px-space-sm bg-surface-container-lowest hover:bg-surface-container-high rounded-md font-label-sm text-primary font-semibold border border-outline-variant/30 transition-colors flex items-center justify-center gap-1"
              >
            ...
            <div className="flex flex-col gap-1">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="font-label-sm text-primary hover:underline text-xs"
                >
