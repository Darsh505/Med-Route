...
STANDARD_PROCEDURES: Dict[str, Dict[str, Any]] = {
    ...
    "kidney-transplant": {
        ...
        "private_tariff_max": 850000,
        "govt_tariff_min": 80000,
        "govt_tariff_max": 150000,
        "implant_details": "Vascular micro-anastomosis grafts & Double-J ureteral stent",
        "icu_days": 7,
        "pre_post_op": "Pre-op cross-match, donor laparoscopic nephrectomy, post-op Doppler & biopsy",
        "inclusions": [
            "Donor laparoscopic organ harvesting & recipient transplant surgery",
            "7 Days post-operative sterile Transplant ICU care",
            "Chief Transplant Surgeon, Nephrologist & Urologist team charges",
            "Induction immunosuppression medication protocol",
            "Post-operative renal arterial Doppler and daily graft function monitoring",
        ],
        "exclusions": [
            "Pre-transplant HLA tissue typing & DNA crossmatch testing",
            "Plasmapheresis or Rituximab desensitization for ABO-incompatible transplants",
            "Extended ICU care exceeding 7 days",
        ],
    },
    "valve-replacement": {
        ...
        "private_tariff_max": 420000,
        "govt_tariff_min": 55000,
        "govt_tariff_max": 95000,
        "implant_details": "1 St. Jude / Medtronic Bi-leaflet Mechanical or Bovine Tissue Valve",
        "icu_days": 3,
        "pre_post_op": "Pre-op 2D-ECHO, Coronary Angiogram, 3 days CTVS ICU, warfarin titration",
        "inclusions": [
            "Open heart surgery with Heart-Lung bypass machine support",
            "1 FDA-Approved Mechanical or Tissue Prosthetic Heart Valve",
            "3 Days in post-operative Cardiac Surgical Intensive Care Unit",
            "Chief Cardiothoracic Surgeon, Perfusionist & Cardiac Anesthesia fees",
            "Post-op anticoagulation titration and daily prothrombin time checks",
        ],
        "exclusions": [
            "Double valve replacement (MVR + AVR billed as separate complex tier)",
            "Intra-Aortic Balloon Pump (IABP) machine support",
            "Emergency off-pump conversion surcharge",
        ],
    },
    "spine-surgery": {
        ...
        "private_tariff_min": 165000,
        "private_tariff_max": 260000,
        "govt_tariff_min": 30000,
        "govt_tariff_max": 60000,
        "implant_details": "4 Titanium Pedicle Screws, Connecting Rods & 1 PEEK Interbody Cage",
        "icu_days": 1,
        "pre_post_op": "Pre-op Spine MRI, dynamic X-rays, 5 days hospital stay, neuro-rehabilitation",
        "inclusions": [
            "High-grade Titanium Pedicle Screws, Connecting Rods & PEEK Cage",
            "Microscopic spinal canal decompression & nerve root neurolysis",
            "1 Day High-Dependency Unit + 4 Days in-hospital recovery care",
            "Senior Neurosurgeon & Spine Anesthesiologist fee",
            "Digital C-Arm fluoroscopic intra-operative imaging guidance",
        ],
        "exclusions": [
            "Multi-level spinal instrumentation exceeding 2 spinal segments",
            "Recombinant Bone Morphogenetic Protein (rhBMP-2) bone graft surcharge",
            "Post-discharge custom lumbar-sacral orthosis (LSO) brace",
        ],
    },
    "hernia-repair": {
        ...
        "private_tariff_max": 95000,
        "govt_tariff_min": 0,
        "govt_tariff_max": 12000,
        "implant_details": "3D Anatomical Polypropylene / Lightweight Mesh + Fixation Tackers",
        "icu_days": 0,
        "pre_post_op": "Pre-op ultrasound, day-care or 1-day admission, post-op dressing kit",
        "inclusions": [
            "Minimal-access 3-port laparoscopic TEP or TAPP procedure",
            "3D Anatomical Polypropylene Hernia Mesh and surgical tackers",
            "Senior Laparoscopic Surgeon, Assistant Surgeon & Anesthesia fees",
            "Pre-procedure blood work and ultrasound of inguinal canal",
            "Routine generic post-operative pain management medications",
        ],
        "exclusions": [
            "Bilateral (both sides) hernia repair performed in same session (+40% surcharge)",
            "Complex recurrent or strangulated obstructed hernia emergency conversion",
        ],
    },
    "chemotherapy": {
        ...
        "private_tariff_max": 65000,
        "govt_tariff_min": 0,
        "govt_tariff_max": 6000,
        "implant_details": "Chemoport access needle & sterile cytotoxic infusion set",
        "icu_days": 0,
        "pre_post_op": "Pre-chemo Complete Blood Count (CBC), liver & renal function tests",
        "inclusions": [
            "Daycare oncology infusion bed with specialized chemo nursing care",
            "Senior Medical Oncologist consultation and regimen review",
            "Pre-medication antiemetic and hydration infusion",
            "Cytotoxic drug reconstitution under sterile biosafety laminar airflow hood",
            "Emergency hypersensitivity and anaphylaxis monitoring protocols",
        ],
        "exclusions": [
            "High-cost targeted immunotherapy monoclonal antibodies (e.g. Pembrolizumab)",
            "Colony-stimulating factor (G-CSF) injections for low WBC counts",
        ],
    },
}
